...
def init_lstm(Config, X_test):
    ...
    saver.restore(session, "C:\\Users\\james\\Documents\\GitHub\\ADIM\\Activity Recognition\\HAR-stacked-residual-bidir-LSTMs-master\\production\\trained_checkpoint\\trained_model")   
    return [lstm, session, X, is_train]
        
def predict(nn_vars, sample):
